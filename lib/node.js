const basicStats =require("../postgresDB/utils/basicStats");
...
Node.prototype.getInfo = function(callback)
{
	return {
		...
		stats: {
			...
			hBlockTime: this.stats.hBlockTime,
			hTxCount: this.stats.hTxCount,
		},
...
Node.prototype.setStats = function(stats, history, callback)
{
	...
	{
		console.log("basicSTATS in setStats node>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
		console.log(stats)
...
Node.prototype.setBasicStats = function(stats, callback)
{
	...
	if( !_.isUndefined(stats) )
	{
		...
		}) )
		{
			...
			this.stats.hBlockTime = stats.hBlockTime;
			this.stats.hTxCount = stats.hTxCount;
